...
var _ohanhi$elm_native_ui$App_Rest$getScheduleCmd = A2(
	...
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(
			...
			'https://elmeurope-api-utmdwkvyqq.now.sh/schedule',
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi$string(
						A2(_elm_lang$core$Basics_ops['++'], 'Talk: ', talk.title)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi$string(
							A2(_elm_lang$core$Basics_ops['++'], 'Speaker: ', talk.speaker)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
